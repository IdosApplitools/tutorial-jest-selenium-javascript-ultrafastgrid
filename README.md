...
The main test case is [`AcmeBankTests.test.js`](https://github.com/IdosApplitools/tutorial-jest-selenium-javascript-ultrafastgrid/blob/main/test/AcmeBankTests.test.js).
